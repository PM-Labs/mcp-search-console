...
ssh root@170.64.197.158 "cd /opt/pmin-mcpinfrastructure && docker compose pull search-console && docker compose up -d search-console"
```

## Rollback

```bash
ssh root@170.64.197.158 "cd /opt/pmin-mcpinfrastructure && docker compose stop search-console"
